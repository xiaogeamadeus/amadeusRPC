...
PATH_AMADEUSRPC = amadeusRPC
PATH_COMM = $(PATH_AMADEUSRPC)/common
PATH_NET = $(PATH_AMADEUSRPC)/net
PATH_TCP = $(PATH_AMADEUSRPC)/net/tcp
PATH_CODER = $(PATH_AMADEUSRPC)/net/coder
PATH_RPC = $(PATH_AMADEUSRPC)/net/rpc

PATH_TESTCASES = testcases

# will install lib to /usr/lib/libamadeusrpc.a
PATH_INSTALL_LIB_ROOT = /usr/lib

# will install all header file to /usr/include/amadeusrpc
...
CXXFLAGS += -I./ -I$(PATH_AMADEUSRPC)	-I$(PATH_COMM) -I$(PATH_NET) -I$(PATH_TCP) -I$(PATH_CODER) -I$(PATH_RPC)
...
LIB_OUT := $(PATH_LIB)/libamadeusrpc.a
...
$(LIB_OUT): $(COMM_OBJ) $(NET_OBJ) $(TCP_OBJ) $(CODER_OBJ) $(RPC_OBJ)
	cd $(PATH_OBJ) && ar rcv libamadeusrpc.a *.o && cp libamadeusrpc.a ../lib/
...
# to clean
clean :
	rm -f $(COMM_OBJ) $(NET_OBJ) $(TESTCASES) $(TEST_CASE_OUT) $(PATH_LIB)/libamadeusrpc.a $(PATH_OBJ)/libamadeusrpc.a $(PATH_OBJ)/*.o
...
# uninstall
uninstall:
	rm -rf $(PATH_INSTALL_INC_ROOT)/amaduesRPC && rm -f $(PATH_INSTALL_LIB_ROOT)/libamadeusrpc.a